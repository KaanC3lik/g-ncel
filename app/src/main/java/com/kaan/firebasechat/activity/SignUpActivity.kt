    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSignUp.setOnClickListener {
            ...
            if (TextUtils.isEmpty(schoolId)) {
                Toast.makeText(applicationContext, "schoolId is required", Toast.LENGTH_SHORT).show()
            }
            if (TextUtils.isEmpty(department)) {
                Toast.makeText(applicationContext, "department is required", Toast.LENGTH_SHORT).show()
            }
            if (TextUtils.isEmpty(section)) {
                Toast.makeText(applicationContext, "section is required", Toast.LENGTH_SHORT).show()
            }
